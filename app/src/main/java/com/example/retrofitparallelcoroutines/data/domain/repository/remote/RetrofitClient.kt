...
import com.example.retrofitparallelcoroutines.data.constants.GeneralConstants.RETROFIT_TIMEOUT_IN_SECOND
...
object RetrofitClient {
    ...
    init {
        ...
        retrofit = Retrofit.Builder()
            .baseUrl("https://mock-movilidad.vass.es/api/formacion/")
